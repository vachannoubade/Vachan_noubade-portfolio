...
export function CTASection() {
  ...
  return (
    <section className="cta-section relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[80vh] flex items-center px-4 py-16 sm:px-6 sm:py-20 md:px-12 md:py-32 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="font-display tracking-[-0.03em] leading-[0.92] sm:leading-[0.95] text-[clamp(1.8rem,8vw,7rem)]">
